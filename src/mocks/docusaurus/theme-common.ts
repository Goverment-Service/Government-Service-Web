export function useThemeConfig() {
  return {
    footer: {
      ...
      copyright: `© ${new Date().getFullYear()} OpenSchool. Licensed under the Apache License 2.0.`,
      links: [
        {
          title: 'Platform',
          items: [
        ...
        },
        {
          title: 'Project',
          items: [
            { label: 'GitHub', href: 'https://github.com/openschool-org/openschool' },
            { label: 'Report an Issue', href: 'https://github.com/openschool-org/openschool/issues' },
            { label: 'Security Policy', href: 'https://github.com/openschool-org/openschool/security/policy' },
            { label: 'Code of Conduct', href: 'https://github.com/openschool-org/openschool/blob/main/CODE_OF_CONDUCT.md' },
          ],
        },
      ],
    },
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/openschool-org/openschool',
          position: 'right',
