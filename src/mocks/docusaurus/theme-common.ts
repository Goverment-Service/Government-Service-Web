export function useThemeConfig() {
  return {
    footer: {
      ...
      copyright: `© ${new Date().getFullYear()} Government Service Navigator. Licensed under the Apache License 2.0.`,
      links: [
        {
          title: 'Platform',
          items: [
        ...
        },
        {
          title: 'Project',
          items: [
            { label: 'GitHub', href: 'https://github.com/Krishmal2004/Government_Service_Navigator' },
            { label: 'Report an Issue', href: 'https://github.com/Krishmal2004/Government_Service_Navigator/issues' },
            { label: 'Security Policy', href: 'https://github.com/Krishmal2004/Government_Service_Navigator/security/policy' },
            { label: 'Code of Conduct', href: 'https://github.com/Krishmal2004/Government_Service_Navigator/blob/main/CODE_OF_CONDUCT.md' },
          ],
        },
      ],
    },
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Krishmal2004/Government_Service_Navigator',
          position: 'right',
